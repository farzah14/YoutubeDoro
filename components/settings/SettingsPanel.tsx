...
export function SettingsPanel({
  ...
  const renderContent = () => {
    ...
    if (section === "about") return <div className="settings-content"><p className="eyebrow">StudyRythms</p><h3>An app specifically designed to track your learning progress</h3><p className="settings-copy">Account-backed sessions, original scenery, layered procedural sound, and your own focus history.</p></div>;
    return null;
  };
