...
export function RotateCcwIcon(props: ComponentProps<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function PictureInPictureIcon(props: ComponentProps<"svg">) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z" />
      <rect x="11" y="12" width="8" height="5" rx="1" />
    </svg>
  );
}
...
export function LightbulbIcon(props: ComponentProps<"svg">) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 18h6" />
      <path d="M10 22h4" />
      <path d="M8.4 14.5A7 7 0 1 1 15.6 14.5c-.8.6-1.4 1.5-1.6 2.5h-4c-.2-1-.8-1.9-1.6-2.5Z" />
    </svg>
  );
}
...
export function WaveformIcon(props: ComponentProps<"svg">) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" {...props}>
      <path d="M4 12v2M8 8v8M12 4v16M16 7v10M20 10v4" />
    </svg>
  );
}

export function MusicIcon(props: ComponentProps<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function Volume2Icon(props: ComponentProps<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function VolumeXIcon(props: ComponentProps<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/>
...
export function BookmarkIcon(props: ComponentProps<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function TomatoIcon({
  ...
  return (
    ...
    >
      {/* Tomato Body */}
      <path
        d="M12 21.5c-4.97 0-9-3.58-9-8 0-4.05 3.32-7.38 7.5-7.92.5-.06 1-.08 1.5-.08s1 .02 1.5.08c4.18.54 7.5 3.87 7.5 7.92 0 4.42-4.03 8-9 8z"
      ...
      />
      <path
        d="M12 5.5c-1.2-1.5-3.2-1.8-4.5-1 1 1.2 1.2 2.5 1 3.5"
      ...
      />
      <path
        d="M12 5.5c1.2-1.5 3.2-1.8 4.5-1-1 1.2-1.2 2.5-1 3.5"
        fill={active ? "#10B981" : "none"}
        stroke={active ? "#059669" : "currentColor"}
        strokeWidth="1.2"
        strokeLinecap="round"
